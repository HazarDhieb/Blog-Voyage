...
export const ARTICLE: Article[] = [

    {
        ...
        secondaryPicture: ['assets/Tunis.png', 'assets/Eljem.png', 'assets/Monterrico.png', 'assets/Guatemala.png'],
        ...
        resume: `La Gréce est un pays que nous avons adoré visiter, 
    ...
    },
    {
        ...
        dateBegin:"Du 14.04.22",
        dateEnd: " au 17.05.22 ",
        picture: 'assets/Tunis.png',
        secondaryPicture: ['assets/Athène.png', 'assets/Eljem.png', 'assets/Monterrico.png', 'assets/Guatemala.png'],
        positifPoint: [`Un pays très simple à sillonner`, 'sans embrouilles ni complexité Des habitants gentils',
            'spontanés et qui cherchent le contact Un relief vallonné', 'offrant de superbes paysages dotés de villages pittoresques'],
        advice: ['Prenez une paire de tong !'],
        negatifPoint: ['Le climat torride en juillet-août', `sauf en montagne La côte très fréquentée l’été et de plus en plus bétonnée`],
        resume: `Sidi-Bousaid est un pays que nous avons adoré visiter, 
        en grande partie grâce à l’accueil chaleureux des Albanais, mais pas seulement !
         Nous avons découvert une culture fièrement préservée, une variété de paysages captivante 
         et de nombreux coins tranquilles, y compris au mois de juillet. Seule la côte adriatique
          sature de touristes l’été. Notre conseil, si vous venez à cette saison, serait alors 
    ...
    },
    {
        ...
        dateBegin:"Du 14.04.22",
        dateEnd: " au 17.05.22 ",
        picture: 'assets/Eljem.png',
        secondaryPicture: ['assets/Tunis.png', 'assets/Athène.png', 'assets/Monterrico.png', 'assets/Guatemala.png'],
        positifPoint: [`Un pays très simple à sillonner`, 'sans embrouilles ni complexité Des habitants gentils',
            'spontanés et qui cherchent le contact Un relief vallonné', 'offrant de superbes paysages dotés de villages pittoresques'],
        advice: ['Prenez une paire de tong !'],
        negatifPoint: ['Le climat torride en juillet-août', `sauf en montagne La côte très fréquentée l’été et de plus en plus bétonnée`],
        resume: `El Jem est un pays que nous avons adoré visiter, 
        en grande partie grâce à l’accueil chaleureux des Albanais, mais pas seulement !
         Nous avons découvert une culture fièrement préservée, une variété de paysages captivante 
         et de nombreux coins tranquilles, y compris au mois de juillet. Seule la côte adriatique
          sature de touristes l’été. Notre conseil, si vous venez à cette saison, serait alors 
    ...
    },
    {
        ...
        dateBegin:"Du 14.04.22",
        dateEnd: " au 17.05.22 ",
        picture: 'assets/Monterrico.png',
        secondaryPicture: ['assets/Tunis.png', 'assets/Eljem.png', 'assets/Monterrico.png', 'assets/Athène.png'],
        positifPoint: [`Un pays très simple à sillonner`, 'sans embrouilles ni complexité Des habitants gentils',
            'spontanés et qui cherchent le contact Un relief vallonné', 'offrant de superbes paysages dotés de villages pittoresques'],
        advice: ['Prenez une paire de tong !'],
        negatifPoint: ['Le climat torride en juillet-août', `sauf en montagne La côte très fréquentée l’été et de plus en plus bétonnée`],
        resume: `Guatemala est un pays que nous avons adoré visiter, 
        en grande partie grâce à l’accueil chaleureux des Albanais, mais pas seulement !
         Nous avons découvert une culture fièrement préservée, une variété de paysages captivante 
         et de nombreux coins tranquilles, y compris au mois de juillet. Seule la côte adriatique
          sature de touristes l’été. Notre conseil, si vous venez à cette saison, serait alors 
    ...
    },
    {
        ...
        dateBegin:"Du 14.04.22",
        dateEnd: " au 17.05.22 ",
        picture: 'assets/barcelone.jpg',
        secondaryPicture: ['assets/Tunis.png', 'assets/Eljem.png', 'assets/Monterrico.png', 'assets/Athène.png'],
        positifPoint: [`Un pays très simple à sillonner`, 'sans embrouilles ni complexité Des habitants gentils',
            'spontanés et qui cherchent le contact Un relief vallonné', 'offrant de superbes paysages dotés de villages pittoresques'],
        advice: ['Prenez une paire de tong !'],
        negatifPoint: ['Le climat torride en juillet-août', `sauf en montagne La côte très fréquentée l’été et de plus en plus bétonnée`],
        resume: `L'Espagne est un pays que nous avons adoré visiter, 
        en grande partie grâce à l’accueil chaleureux des Albanais, mais pas seulement !
         Nous avons découvert une culture fièrement préservée, une variété de paysages captivante 
         et de nombreux coins tranquilles, y compris au mois de juillet. Seule la côte adriatique
          sature de touristes l’été. Notre conseil, si vous venez à cette saison, serait alors 
